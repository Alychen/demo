...
var Windy = function( params ){
  ...
  var animate = function(bounds, field, PARTICLE_MULTIPLIER) {
  ...
  var start = function( bounds, width, height, extent, PARTICLE_MULTIPLIER ){
    ...
    buildGrid( params.data, function(grid){
      ...
      interpolateField( grid, buildBounds( bounds, width, height), mapBounds, function( bounds, field ){
        ...
        windy.field = field;
        animate( bounds, field, PARTICLE_MULTIPLIER );
      });
